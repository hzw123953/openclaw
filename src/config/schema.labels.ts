...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.openaiCodex.strategy": "Codex Search Strategy",
  "tools.web.search.openaiCodex.mode": "Codex Native Search Mode",
  "tools.web.search.openaiCodex.allowedDomains": "Codex Native Search Allowed Domains",
  "tools.web.search.openaiCodex.contextSize": "Codex Native Search Context Size",
  "tools.web.search.openaiCodex.userLocation": "Codex Native Search User Location",
  "tools.web.search.openaiCodex.userLocation.country": "Codex Native Search Country",
  "tools.web.search.openaiCodex.userLocation.region": "Codex Native Search Region",
  "tools.web.search.openaiCodex.userLocation.city": "Codex Native Search City",
  "tools.web.search.openaiCodex.userLocation.timezone": "Codex Native Search Timezone",
